...
import { ReactComponent as WsIcon } from "images/whatsapp-icon.svg";
  ...
  return (
    <Container>
      <Content>
        <ThreeColRow>
          <LogoContainer>
            <LogoImg src='./imgs/NUEVOLOGOPERFIL.png' />
            <LogoText>Viper Games</LogoText>
          </LogoContainer>
          <SocialLinksContainer>
            <SocialLink href="https://facebook.com/ViperGamescba/">
              <FacebookIcon />
            </SocialLink>
